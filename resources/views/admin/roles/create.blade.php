    ...
    <div class="bg-white rounded-2xl shadow p-6">
        ...
        <form action="{{ route('admin.roles.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                />
                <p class="text-xs text-gray-400 mt-1.5">Gunakan huruf kecil dan underscore saja. Contoh: <code class="bg-gray-100 px-1 rounded">kasir</code>, <code class="bg-gray-100 px-1 rounded">super_admin</code></p>
                @error('name')
