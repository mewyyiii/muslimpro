...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* =========================================================
           DESKTOP — split layout (tetap seperti aslinya)
        ========================================================= */
        body {
            display: flex;
            min-height: 100vh;
        ...
        .cover-headline {
            ...
            color: white; line-height: 1.2; margin-bottom: 16px; letter-spacing: -0.5px;
        }
        .cover-headline span { display: block; color: #ccfbf1; font-style: italic; }

        .cover-sub {
            font-size: clamp(13px,1.2vw,15px); color: rgba(255,255,255,0.8);
        ...
        .arabic-quote {
            font-family: 'Amiri', serif; font-size: 20px; color: rgba(255,255,255,0.6);
            border-top: 1px solid rgba(255,255,255,0.2); padding-top: 20px;
            direction: rtl; letter-spacing: 1px;
        }
        .arabic-quote-trans {
            font-size: 12px; color: rgba(255,255,255,0.5);
            margin-top: 6px; direction: ltr; font-style: italic;
        }
        ...
        .input-icon {
            ...
            width: 17px; height: 17px; color: var(--teal); pointer-events: none;
        }
        ...
        .field-error {
            display: none; font-size: 11.5px; color: #ef4444;
        ...
        .register-btn {
            ...
            color: white; box-shadow: 0 6px 20px rgba(13,148,136,0.35);
            transition: all 0.25s; letter-spacing: 0.5px; margin-top: 18px;
        }
        ...
        /* =========================================================
           MOBILE — style seperti referensi gambar kedua
           Putih bersih, compact header, label atas input, clean card
        ========================================================= */
        @media (max-width: 900px) {
            ...
            /* ---- Header mobile: compact teal strip ---- */
            .cover-panel {
                position: relative;
                height: auto;
                min-height: auto;
            ...
            .blob, .pattern-overlay, .deco-circles,
            .arabic-quote, .feature-pills, .cover-sub { display: none; }
            ...
            /* ---- Form panel mobile: card putih melayang ---- */
            .form-panel {
                flex: 1;
                min-height: auto;
            ...
            .form-inner {
                ...
                /* Naik sedikit ke atas menutup header */
                margin-top: -20px;
                position: relative;
                z-index: 10;
            }
            ...
            /* Input tanpa icon di mobile — lebih mirip referensi */
            .input-label {
                font-size: 13px;
                font-weight: 600;
                color: #334155;
            ...
            /* Di mobile: sembunyikan icon kiri, padding normal */
        ...
        @media (max-width: 480px) {
            ...
            .form-inner { padding: 24px 18px 24px; border-radius: 20px; }
        }
    ...
    <div class="cover-panel">
        ...
        <div class="cover-content">
            ...
            <div class="feature-pills">
                <div class="pill">
                    <span class="pill-icon"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="white" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg></span>
                    Pelacak Ibadah
                </div>
                <div class="pill">
                    <span class="pill-icon"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="white" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></span>
                    Pengingat Shalat
                </div>
                <div class="pill">
                    <span class="pill-icon"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="white" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg></span>
                    Catatan Al-Qur'an
                </div>
                <div class="pill">
    ...
    <div class="form-panel">
        <div class="form-inner">
            ...
            <form method="POST" action="#" id="register-form" novalidate>
                ...
                <!-- Nama Pengguna -->
                <div class="form-group">
                    <label class="input-label" for="input-username">Nama Pengguna</label>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper" id="password-wrapper">
                        ...
                        <input type="password" id="input-password" name="password"
                            ...
                            onblur="validatePassword()" oninput="checkStrength()">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper" id="confirm-password-wrapper">
                        ...
                        <input type="password" id="input-confirm" name="password_confirmation"
                            ...
                            onfocus="setFocus('confirm-password-wrapper')" onblur="validateConfirm()">
...
<script>
    ...
    function lockPasswordFields(lock) {
        [['input-password','password-wrapper','Minimal 6 karakter'],
         ['input-confirm','confirm-password-wrapper','Ulangi kata sandi']].forEach(function(p) {
            var inp = document.getElementById(p[0]);
            var w   = document.getElementById(p[1]);
            if (lock) { inp.disabled=true; w.classList.add('locked'); inp.placeholder='Isi email yang valid dulu'; }
            else { inp.disabled=false; w.classList.remove('locked','error','valid','focused'); inp.placeholder=p[2]; }
        });
    }
