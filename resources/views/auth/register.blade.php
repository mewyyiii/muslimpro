...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .register-btn { width: 100%; padding: 14px; border: none; border-radius: 12px; font-size: 15px; font-weight: 700; font-family: inherit; cursor: pointer; background: linear-gradient(135deg, #0d9488, #14b8a6); color: white; box-shadow: 0 6px 20px rgba(13,148,136,0.35); transition: all 0.25s; letter-spacing: 0.5px; margin-top: 18px; }
            ...
            <form method="POST" action="{{ route('register') }}" id="register-form" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper" id="name-wrapper">
                        ...
                        <input type="text" id="input-name" name="name" class="form-input" placeholder="Nama lengkap Anda" value="{{ old('name') }}" required autofocus onfocus="setFocus('name-wrapper')" onblur="validateName()">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper" id="username-wrapper">
                        ...
                        <input type="text" id="input-username" name="username" class="form-input" placeholder="Nama pengguna (opsional)" value="{{ old('username') }}" onfocus="setFocus('username-wrapper')" onblur="document.getElementById('username-wrapper').classList.remove('focused')">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper" id="password-wrapper">
                        ...
                        <input type="password" id="input-password" name="password" class="form-input has-eye" placeholder="Minimal 6 karakter" required onfocus="setFocus('password-wrapper')" onblur="validatePassword()" oninput="checkStrength()">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper" id="confirm-password-wrapper">
                        ...
                        <input type="password" id="input-confirm" name="password_confirmation" class="form-input has-eye" placeholder="Ulangi kata sandi" required onfocus="setFocus('confirm-password-wrapper')" onblur="validateConfirm()">
...
<script>
    ...
    function lockPasswordFields(lock) { [['input-password','password-wrapper','Minimal 6 karakter'],['input-confirm','confirm-password-wrapper','Ulangi kata sandi']].forEach(function(p) { var inp = document.getElementById(p[0]); var w = document.getElementById(p[1]); if (lock) { inp.disabled=true; w.classList.add('locked'); inp.placeholder='Isi email yang valid dulu'; } else { inp.disabled=false; w.classList.remove('locked','error','valid','focused'); inp.placeholder=p[2]; } }); }
