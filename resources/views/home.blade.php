...
function prayerWidget() {
    return {
        ...
        prayerIcons: {
            ...
            maghrib: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5"><path d="M12 2V4M5.5 5.5L6.9 6.9M18.5 5.5L17.1 6.9M3 11H5M19 11H21" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M5 13C5 9.69 8.13 7 12 7C15.87 7 19 9.69 19 13" stroke="currentColor" stroke-linecap="round" stroke-width="1.8"/><path d="M3 13H21" stroke="currentColor" stroke-linecap="round" stroke-width="2.2"/><path d="M6 17H18" stroke="currentColor" stroke-linecap="round" stroke-width="1.8"/></svg>`,
