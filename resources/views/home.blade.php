...
function nextPrayerMini() {
    return {
        ...
        icons: {
            ...
            asr:     `<svg style="width:16px;height:16px;" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M12 1V3" stroke-width="1.8" stroke-linecap="round"/><path d="M5 4L6.4 5.4" stroke-width="1.8" stroke-linecap="round"/><path d="M19 4L17.6 5.4" stroke-width="1.8" stroke-linecap="round"/><path d="M2 10H4" stroke-width="1.8" stroke-linecap="round"/><path d="M20 10H22" stroke-width="1.8" stroke-linecap="round"/><circle cx="12" cy="10" r="3" stroke-width="1.8"/><path d="M3 16H21" stroke-width="1.8" stroke-linecap="round"/><path d="M6 19H18" stroke-width="1.8" stroke-linecap="round"/></svg>`,
            maghrib: `<svg style="width:16px;height:16px;" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M12 2V4" stroke-width="1.8" stroke-linecap="round"/><path d="M4.5 4.5L5.9 5.9" stroke-width="1.8" stroke-linecap="round"/><path d="M19.5 4.5L18.1 5.9" stroke-width="1.8" stroke-linecap="round"/><path d="M2 9H4" stroke-width="1.8" stroke-linecap="round"/><path d="M20 9H22" stroke-width="1.8" stroke-linecap="round"/><path d="M6 14 A6 6 0 0 1 18 14" stroke-width="1.8" stroke-linecap="round" fill="none"/><path d="M3 14H21" stroke-width="1.8" stroke-linecap="round"/><path d="M6 17H18" stroke-width="1.8" stroke-linecap="round"/></svg>`,
