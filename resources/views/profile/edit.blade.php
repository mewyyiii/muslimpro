            ...
            <div class="bg-white rounded-3xl p-8 shadow-2xl border-2 border-red-200"
                 x-data="{
                     ...
                     async submitDelete() {
                         ...
                         if (!pwd) {
                             this.pwError = 'Kata sandi wajib diisi.';
                             return;
                         }
                         this.pwError = '';
                         this.pwLoading = true;
                         try {
                             ...
                             if (data.valid) {
                                 ...
                                 this.pwError = 'Kata sandi salah. Silakan coba lagi.';
                                 this.pwLoading = false;
                                 document.getElementById('delete-password').focus();
                             }
                         } catch(e) {
                             this.pwError = 'Terjadi kesalahan. Silakan coba lagi.';
                             this.pwLoading = false;
                         }
                     }
                 }"
                 x-init="$watch('showDeleteModal', v => { if(!v) resetModal(); })">
                ...
                {{-- Form tersembunyi untuk submit setelah verifikasi berhasil --}}
                ...
                <div x-show="showDeleteModal"
                    ...
                    <div class="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-lg">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                <input type="password" id="delete-password" placeholder="Masukkan kata sandi"
                                       :class="pwError ? 'border-red-400 focus:border-red-400 focus:ring-red-400/20' : 'border-gray-200 focus:border-red-400 focus:ring-red-400/20'"
                                       class="w-full px-4 py-3 pr-12 rounded-xl border-2 bg-white focus:outline-none focus:ring-4 transition-all"
                                       @keydown.enter.prevent="submitDelete()"
                                       @input="pwError = ''">
                                <button type="button"
                                        tabindex="-1"
                                        onclick="toggleDelEye()"
                                        class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-red-500 transition-colors"
                                        style="line-height:0;">
                                    <svg id="del-eye-open" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                    </svg>
                                    <svg id="del-eye-closed" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display:none;">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/>
                                    </svg>
                                </button>
                            </div>
                            {{-- Error langsung tanpa reload --}}
                            <p x-show="pwError" x-text="pwError" class="mt-2 text-sm text-red-600 font-semibold" style="display:none;"></p>
                        </div>
...
function toggleDelEye() {
    var inp = document.getElementById('delete-password');
    var eo  = document.getElementById('del-eye-open');
    var ec  = document.getElementById('del-eye-closed');
